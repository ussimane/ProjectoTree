 ...
 * @author MASSINGUE
 */
public class CadastrarUtilizador extends javax.swing.JDialog {

    /**
     * Creates new form CadastrarUtilizador
     */
    public CadastrarUtilizador(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try {
            initComponents();
        ...
        this.setLocation((centro.width - getWidth()) / 2, (centro.height - getHeight()) / 2);
            ...
            Logger.getLogger(CadastrarUtilizador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastrarUtilizador dialog = new CadastrarUtilizador(new javax.swing.JFrame(), true);
    ...
    private void cadastrarCurso() {
        ...
        u.setUtilizador(txtUtilizador.getText());
        u.setSenha(txtSenha.getText());
        u.setIdprevilegio(new Previlegio(comboprevilegio.getSelectedIndex()+1));
        new UtilizadorJpaController().create(u);
