 ...
 */
@Entity
@Table(name = "relchefefamilia", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relchefefamilia.findAll", query = "SELECT r FROM Relchefefamilia r")})
public class Relchefefamilia implements Serializable {
    ...
    public Relchefefamilia() {
    }

    public Relchefefamilia(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relchefefamilia)) {
            return false;
        }
        Relchefefamilia other = (Relchefefamilia) object;
    ...
    public String toString() {
        return "Modelo.Relchefefamilia[ localidade=" + localidade + " ]";
    }
