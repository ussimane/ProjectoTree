 ...
 */
@Entity
@Table(name = "relcasapropria", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relcasapropria.findAll", query = "SELECT r FROM Relcasapropria r")})
public class Relcasapropria implements Serializable {
    ...
    public Relcasapropria() {
    }

    public Relcasapropria(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relcasapropria)) {
            return false;
        }
        Relcasapropria other = (Relcasapropria) object;
    ...
    public String toString() {
        return "Modelo.Relcasapropria[ localidade=" + localidade + " ]";
    }
