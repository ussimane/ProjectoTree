 ...
 */
@Entity
@Table(name = "reldeficiente", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Reldeficiente.findAll", query = "SELECT r FROM Reldeficiente r")})
public class Reldeficiente implements Serializable {
    ...
    public Reldeficiente() {
    }

    public Reldeficiente(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Reldeficiente)) {
            return false;
        }
        Reldeficiente other = (Reldeficiente) object;
    ...
    public String toString() {
        return "Modelo.Reldeficiente[ localidade=" + localidade + " ]";
    }
