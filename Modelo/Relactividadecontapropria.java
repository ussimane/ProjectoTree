 ...
 */
@Entity
@Table(name = "relactividadecontapropria", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relactividadecontapropria.findAll", query = "SELECT r FROM Relactividadecontapropria r")})
public class Relactividadecontapropria implements Serializable {
    ...
    public Relactividadecontapropria() {
    }

    public Relactividadecontapropria(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relactividadecontapropria)) {
            return false;
        }
        Relactividadecontapropria other = (Relactividadecontapropria) object;
    ...
    public String toString() {
        return "Modelo.Relactividadecontapropria[ localidade=" + localidade + " ]";
    }
