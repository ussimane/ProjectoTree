 ...
 */
@Entity
@Table(name = "relfilhos", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relfilhos.findAll", query = "SELECT r FROM Relfilhos r")})
public class Relfilhos implements Serializable {
    ...
    public Relfilhos(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relfilhos)) {
            return false;
        }
        Relfilhos other = (Relfilhos) object;
    ...
    public String toString() {
        return "Modelo.Relfilhos[ localidade=" + localidade + " ]";
    }
