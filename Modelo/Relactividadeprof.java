 ...
 */
@Entity
@Table(name = "relactividadeprof", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relactividadeprof.findAll", query = "SELECT r FROM Relactividadeprof r")})
public class Relactividadeprof implements Serializable {
    ...
    public Relactividadeprof() {
    }

    public Relactividadeprof(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relactividadeprof)) {
            return false;
        }
        Relactividadeprof other = (Relactividadeprof) object;
    ...
    public String toString() {
        return "Modelo.Relactividadeprof[ localidade=" + localidade + " ]";
    }
