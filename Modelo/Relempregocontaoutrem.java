 ...
 */
@Entity
@Table(name = "relempregocontaoutrem", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Relempregocontaoutrem.findAll", query = "SELECT r FROM Relempregocontaoutrem r")})
public class Relempregocontaoutrem implements Serializable {
    ...
    public Relempregocontaoutrem() {
    }

    public Relempregocontaoutrem(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Relempregocontaoutrem)) {
            return false;
        }
        Relempregocontaoutrem other = (Relempregocontaoutrem) object;
    ...
    public String toString() {
        return "Modelo.Relempregocontaoutrem[ localidade=" + localidade + " ]";
    }
