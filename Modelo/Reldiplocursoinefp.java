 ...
 */
@Entity
@Table(name = "reldiplocursoinefp", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Reldiplocursoinefp.findAll", query = "SELECT r FROM Reldiplocursoinefp r")})
public class Reldiplocursoinefp implements Serializable {
    ...
    public Reldiplocursoinefp() {
    }

    public Reldiplocursoinefp(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Reldiplocursoinefp)) {
            return false;
        }
        Reldiplocursoinefp other = (Reldiplocursoinefp) object;
    ...
    public String toString() {
        return "Modelo.Reldiplocursoinefp[ localidade=" + localidade + " ]";
    }
