 ...
 */
@Entity
@Table(name = "reldiplocursoprof", catalog = "ptree", schema = "")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Reldiplocursoprof.findAll", query = "SELECT r FROM Reldiplocursoprof r")})
public class Reldiplocursoprof implements Serializable {
    ...
    public Reldiplocursoprof() {
    }

    public Reldiplocursoprof(String localidade) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Reldiplocursoprof)) {
            return false;
        }
        Reldiplocursoprof other = (Reldiplocursoprof) object;
    ...
    public String toString() {
        return "Modelo.Reldiplocursoprof[ localidade=" + localidade + " ]";
    }
